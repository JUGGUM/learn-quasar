<template>
  <q-page class='q-pa-xl'>
    <section class='q-mb-xl'>
      <div class='text-h4 text-bold flex flex-center'>Spacing</div>
      <q-separator class='q-my-md'/>
      <div class='bg-primary q-pa-xs'>
        <div class='bg-dark text-white'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui quasi cumsed a voluptate
          atque, corrupti eaque in fugit, sacepe nesciunt! Veniam consectetur excepturi natus
    ...
    <section class='q-mb-xl'>
      <div class='text-h4 text-bold flex flex-center'>Components</div>
      <q-separator class='q-my-md'/>
