    ...
    <section class="row q-col-gutter-x-xl q-py-lg">
      ...
      <div class="col-12 col-sm-grow column justify-between">
        <div class="row items-center">
          <span class="text-h6 text-weight-bold">gayoung.gram</span>
          <q-space />
        ...
        <div>
          <div>플라잉요가</div>
          <div>#ISTJ 인스타잘안해요</div>
          <div>linktr.ee/gayoung</div>
        </div>
      </div>
    </section>
    <section>
...
<!--    <q-tab name="mails" icon="mail" label="게시글" />
        ...
        <q-route-tab :ripple=false icon="bookmarks" to="/profile/saved" label='저장됨' exact />
